    ...
    <footer className="border-t border-[#334D40]/15 bg-[#334D40] text-[#DBD7CB]">
      <div className="mx-auto grid w-full max-w-6xl gap-4 px-4 py-10 sm:px-6 md:grid-cols-2">
        <div>
          ...
          <p className="mt-3 text-sm text-[#DBD7CB]/85">{config.address}</p>
        </div>
        ...
        <div className="space-y-2 text-sm">
          ...
          <p>
            <span className="font-semibold">WhatsApp:</span> {config.whatsappNumber}
          </p>
          <p>
            <span className="font-semibold">CNPJ:</span> {config.cnpj}
          </p>
        </div>
      </div>
    </footer>
